...
pa("--seq_length", type=int, default=32, help="Max sequence length")
...
pa("--alpha", type=float, default=1, help="What percentage of SNLI data to use in training")
...
pa("--batch_size", type=int, default=56, help="batch size") ####
...
def load_parameters():
    FIXED_PARAMETERS = {
        ...
        "alpha": args.alpha,
        "genre": args.genre,
        "image_feature":"{}/snli_image_feature/Flickr30k_feature_pool5.jsonl".format(args.datapath)
    }
